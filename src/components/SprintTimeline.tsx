  ...
  const steps = [
    {
      days: 'Days 1–2',
      title: 'Scope & Plan',
      description: 'We dive deep into your requirements, define clear deliverables, and create a detailed technical roadmap.',
    ...
    },
    {
      days: 'Days 3–10',
      title: 'Build & Iterate',
      description: 'Our team builds your solution using Go, AI/ML frameworks, and modern best practices. Daily progress updates keep you in the loop.',
    ...
    },
    {
      ...
      description: 'We polish the experience, fix edge cases, conduct thorough testing, and optimize performance for production.',
